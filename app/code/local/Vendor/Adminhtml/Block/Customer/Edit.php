 ...
 */
class Vendor_Adminhtml_Block_Customer_Edit extends Mage_Adminhtml_Block_Customer_Edit
{
    public function __construct()
    {
        ...
        if (Mage::registry('current_customer')->getStatus()=='2') {
         ...
         $this->_updateButton('delete', 'label', Mage::helper('customer')->__('Disable Customer'));   
        }
